...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pycompare-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6464&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pycompare-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pycompare` can be installed with:

```
conda install pycompare
```

It is possible to list all of the versions of `pycompare` available on your platform with:
